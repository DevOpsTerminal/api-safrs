...
app.config.update( SQLALCHEMY_DATABASE_URI = 'sqlite://',
                   DEBUG = True,
                   CSRF_SECRET_KEY=b'qsdffrhovdbjkxcwbuisidf')
...
@app.before_request
def before_request():
    _insecure_views = ['do_login','get_resource', 'new_user', 'get_auth_token', 'get_user', 'admin.login_view', 'admin.index', 'do_logout', 'jsonapi_admin_static', 'admin.static']
